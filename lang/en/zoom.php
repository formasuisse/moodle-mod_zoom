...
$string['plandatesintro'] = 'Plan every occurrence of this meeting here — they all share one join link and one recordings list. A host is booked for the whole plan when you save; afterwards, occurrences are added, moved or cancelled one by one in the occurrences table on the activity page.';
