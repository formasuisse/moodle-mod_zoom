...
$string['event_collision_imminent'] = 'Zoom host collision imminent';
...
$string['occ_cancel_confirm_btn'] = 'Confirm cancellation';
...
$string['occ_discard'] = 'Discard';
$string['occ_discard_confirm_btn'] = 'Confirm discard';
$string['occ_discard_confirm'] = 'Discard the occurrence of {$a}? It disappears from the list entirely — use this for dates that were never really planned. (To cancel a planned occurrence visibly, use Cancel instead.)';
$string['occ_discarded_notify'] = 'Occurrence discarded.';
...
$string['occ_rec_hide'] = 'Hide';
$string['occ_rec_show'] = 'Show';
$string['occ_recording_started'] = 'Recording started at {$a}';
$string['occ_hide'] = 'Hide from list';
$string['occ_revert'] = 'Revert';
$string['occ_hidden_notify'] = 'Occurrence hidden from the list.';
$string['occ_past'] = 'Past';
$string['occ_planner_addrow'] = 'Add a row';
$string['occ_planner_daily'] = '+5d';
$string['occ_planner_daily_help'] = 'Add 5 daily occurrences after this row (consecutive days, same time and duration)';
$string['occ_planner_monthly'] = '+5m';
$string['occ_planner_monthly_help'] = 'Add 5 occurrences every 4 weeks after this row (same weekday, same time and duration)';
$string['occ_planner_weekly'] = '+5w';
...
$string['occurrencetable'] = 'Show the occurrences table';
$string['occurrencetable_desc'] = 'Pooled mode: show the per-occurrence table (dates, recordings, manage actions) on the activity page, replacing the Schedule section.';
$string['plandate'] = 'Additional occurrence';
$string['plandatesadd'] = 'Add {no} more occurrences';
$string['plandatesintro'] = 'Plan every occurrence of this meeting here — they all share one join link and one recordings list. A host is booked for the whole plan when you save; afterwards, occurrences are added, moved or cancelled one by one in the occurrences table on the activity page. Leave a date empty to skip a row.';
$string['schedulemanagedintable'] = 'The schedule of this meeting is managed occurrence by occurrence in the occurrences table on the <a href="{$a}">activity page</a>.';
$string['zoomerr_last_occurrence'] = 'The last remaining occurrence cannot be cancelled — delete the activity instead.';
...
$string['zoomerr_occurrence_limit'] = 'This meeting has reached the maximum number of occurrences (60, counting cancelled ones). Create a new activity for further occurrences.';
...
$string['teacher_help'] = 'The course teacher who hosts this session: only this person sees the Start meeting button. The Zoom-side host is picked automatically from the host pool.';
...
$string['title'] = 'Title';
$string['topic'] = 'Topic';
$string['sourcetrackingfield'] = 'Source tracking field';
$string['sourcetrackingfield_help'] = 'Name of an existing Zoom tracking field that every meeting created or updated by this plugin is stamped with. This makes plugin-managed meetings distinguishable from meetings created by hand in the Zoom web UI, which carry no such marker. The field must already exist in the Zoom account (Admin &gt; Account Management &gt; Tracking Fields); Zoom silently discards tracking fields it does not recognise. Leave empty to disable. Unlike the tracking fields below, this one is not shown on the activity form and requires nothing from teachers.';
$string['sourcetrackingvalue'] = 'Source tracking field value';
$string['sourcetrackingvalue_help'] = 'Value written into the source tracking field. Defaults to <em>Moodle</em>. Set it to something else when the Zoom tracking field restricts which values it accepts, or when several Moodle sites share one Zoom account and need to be told apart. Ignored unless a source tracking field is named above; if left empty, <em>Moodle</em> is used.';
...
$string['registration_automoodle'] = 'Yes — participants are registered automatically with their Moodle name and join pre-identified (personal link, no form)';
$string['registration_done'] = 'You are registered for this session. The join button will be available at the scheduled time.';
...
$string['zoomerr_pool_noregistrationhost'] = 'Registration requires a licensed Zoom host and the pool has none. Turn registration off for this meeting, or add a licensed host to the pool.';
...
$string['zoomurl_desc'] = '';
$string['purgerecordings'] = 'Purge expired Zoom recordings';
$string['recordingretentiondays'] = 'Recording retention (days)';
$string['recordingretentiondays_help'] = 'If set, cloud recordings are moved to the Zoom trash and removed from Moodle this many days after the session — every previously shared play link stops working at that point. 0 disables the purge.';
$string['recordingretention'] = 'Recording retention (days, empty = site default of {$a})';
$string['recordingretention_help'] = 'How many days after the session the cloud recordings of this activity stay available before they are purged. Leave empty to use the site-wide default. Enter a larger number to keep recordings longer (e.g. until an exam date), a smaller one to purge sooner, or 0 to keep them indefinitely.';
$string['err_recordingretention'] = 'The retention must be empty (site default) or a whole number of days.';
$string['recording_available_until'] = 'Available until {$a}';
$string['recording_expired'] = 'no longer available';
$string['recording_expired_long'] = 'This recording is no longer available: the retention period has ended.';
$string['recording_availability'] = 'Availability';
