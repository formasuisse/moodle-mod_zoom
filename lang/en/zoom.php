...
$string['occ_revive_confirm_btn'] = 'Add the date';
$string['occ_revive_confirm'] = 'This series has ended on Zoom, so continuing it needs a new Zoom meeting. Add {$a}? The join link changes — anyone still holding the old one will need the new link. Past sessions and their recordings are kept.';
$string['occ_revived_notify'] = 'Occurrence added. The series continues on a new Zoom meeting, so the join link has changed.';
...
$string['zoomerr_meetingpurged'] = 'This series has ended on Zoom. Its sessions and recordings are kept here. Add a date below to continue it on a new Zoom meeting.';
$string['zoomerr_meetingpurged_form'] = 'This series has ended on Zoom. Settings saved here are kept and applied when the series is continued by adding a date.';
$string['zoomerr_meetingpurged_info'] = 'This series has ended on Zoom. Its past sessions and recordings are still available below.';
