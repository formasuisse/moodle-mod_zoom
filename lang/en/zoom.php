...
$string['occ_add'] = 'Add a session';
$string['occ_added_notify'] = 'Session added.';
$string['occ_addnew'] = 'New session';
$string['occ_cancel'] = 'Cancel';
$string['occ_cancel_confirm'] = 'Cancel the session of {$a}? It stays listed as cancelled so students see the change. Its slot on the host is freed; the cancellation is permanent on Zoom.';
$string['occ_cancelled'] = 'Cancelled';
$string['occ_cancelled_notify'] = 'Session cancelled.';
$string['occ_date'] = 'Date';
$string['occ_delete'] = 'Delete';
$string['occ_delete_confirm'] = 'Delete the session of {$a}? It disappears from the list entirely — use this for dates that were never really planned. (To cancel a planned session visibly, use Cancel instead.)';
$string['occ_deleted_notify'] = 'Session deleted.';
$string['occ_err_baddate'] = 'This date could not be understood.';
$string['occ_err_past'] = 'Past sessions cannot be changed.';
$string['occ_moved_notify'] = 'Session moved.';
$string['occ_remove'] = 'Remove from list';
$string['occ_removed_notify'] = 'Session removed from the list.';
...
$string['occurrences'] = 'Sessions';
$string['occurrencetable'] = 'Show the sessions table';
$string['occurrencetable_desc'] = 'Pooled mode: show the per-session table (dates, recordings, manage actions) on the activity page, replacing the Schedule section.';
$string['plandate'] = 'Additional session';
$string['plandatesadd'] = 'Add {no} more sessions';
