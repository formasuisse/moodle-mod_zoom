...
$string['occ_cancel_confirm'] = 'Cancel the session of {$a}? Its slot on the host is freed. The cancellation is permanent on Zoom and cannot be undone.';
...
$string['occ_move'] = 'Move';
$string['occ_move_heading'] = 'Move the session of {$a}';
